  ...
  <div class="container-fluid text-center">    
    <div class="row content">
      ...
      <div class="col-sm-10 text-left">
          <div class="col-sm-8">
              <h1>PKBM Belum Terverifikasi</h1>
          </div>
          <div class="col-sm-2">
        ...
        <table>
           <tr>
            ...
            $sql = "SELECT * FROM pkbm WHERE status=0";
            $pkbm = $conn->query($sql);
              ...
              while($row = $pkbm->fetch_assoc()){
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <button type="button" class="button verifybutton" style="height:100%; width:100%;background-color:teal; border-radius:4px;">
...
$(document).ready(function(){
  $(".verifybutton").click(function() {
    ...
    var form = $('<form action="verify.php" method="POST"></form>').appendTo('body');
